...
export const categories = [
    ...
    },
    {
        slug: "crypto",
        name: "Cryptography",
        description: "Learn classic ciphers with interactive encrypt/decrypt demos. Runs locally in your browser.",
        icon: Lock,
        color: "#22c55e",
        tags: ["Caesar", "Vigenère", "Playfair", "Hill"],
    },
];
...
export const tools = [
    ...
    // Cryptography
    {
        ...
        slug: "caesar",
        category: "crypto",
        description: "Encrypt or decrypt text using a classic shift cipher with adjustable rotation.",
        icon: Lock,
        href: "/tools/crypto/caesar",
    },
    {
        name: "Vigenère Cipher",
        slug: "vigenere",
        category: "crypto",
        description: "Encrypt or decrypt text using a keyword-based polyalphabetic substitution cipher.",
        icon: Lock,
        href: "/tools/crypto/vigenere",
    },
    {
        name: "Playfair Cipher",
        slug: "playfair",
        category: "crypto",
        description: "Encrypt or decrypt text using a 5×5 digraph cipher square built from a keyword.",
        icon: Lock,
        href: "/tools/crypto/playfair",
    },
    {
        name: "Hill Cipher",
        slug: "hill",
        category: "crypto",
        description: "Encrypt or decrypt text using an n×n matrix cipher over the alphabet (mod 26).",
        icon: Lock,
        href: "/tools/crypto/hill",
    },
];
