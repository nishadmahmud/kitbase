                    ...
                    <div className="flex gap-16">
                        <div>
                            ...
                            <ul className="list-none p-0 m-0 flex flex-col gap-2">
                                ...
                                <li><a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition-colors no-underline">GitHub</a></li>
                            </ul>
                        </div>
                        <div>
                            <h4 className="text-[11px] font-semibold text-gray-500 uppercase tracking-wider mb-3 mt-0">Legal</h4>
                            <ul className="list-none p-0 m-0 flex flex-col gap-2">
                                <li><Link href="/about" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition-colors no-underline">Privacy</Link></li>
                                <li><Link href="/about" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition-colors no-underline">Terms</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div className="mt-10 pt-6 border-t border-gray-200 dark:border-gray-800 flex flex-wrap justify-between items-center gap-2">
                    <p className="text-xs text-gray-500 m-0">© 2025 Kitbase by Nishad. Open source productivity.</p>
