    ...
    return (
        <div className="min-h-screen bg-gray-950 pb-12">
            ...
            <div className="max-w-5xl mx-auto px-6 -mt-8 relative z-10 grid md:grid-cols-2 gap-8">
                ...
                {/* Inputs */}
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-lg h-fit">
                    <h3 className="text-lg font-bold text-gray-200 mb-6 flex items-center gap-2">
                        <Calculator size={20} className="text-gray-400" /> Loan Details
                    </h3>
                ...
                {/* Results Visual */}
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-lg flex flex-col justify-center">
                    <h3 className="text-lg font-bold text-gray-200 mb-6 flex items-center gap-2">
                        <PieChart size={20} className="text-gray-400" /> Breakdown
                    </h3>
    ...
    return (
        <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
                ...
                <span className={`text-gray-400 ${big ? "font-semibold text-lg" : "font-medium"}`}>{label}</span>
            </div>
            <span className={`font-mono text-gray-200 ${big ? "text-2xl font-bold" : "text-lg"}`}>{value}</span>
        </div>
    );
}
