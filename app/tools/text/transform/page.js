    ...
    return (
        <div className="min-h-screen bg-gray-950 pb-12">
            ...
            <div className="max-w-5xl mx-auto px-6 -mt-8 relative z-10 flex flex-col gap-6">
                ...
                {/* Control Bar */}
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 flex flex-wrap gap-4 justify-center shadow-lg items-center">
                    ...
                    <div className="w-px bg-gray-800 h-10 mx-2 hidden md:block"></div>
                    ...
                    <div className="flex items-center gap-2 bg-gray-950 p-1.5 rounded-xl border border-gray-800">
                        <input
                            ...
                            className="w-16 bg-transparent text-center text-gray-200 outline-none font-bold text-sm"
                        />
...
function ActionButton({ onClick, label, icon: Icon, compact }) {
    return (
        <button
            onClick={onClick}
            className={`flex items-center gap-2 rounded-xl text-sm font-semibold bg-gray-950 text-gray-300 border border-gray-800 hover:bg-gray-800 hover:text-white hover:border-gray-600 transition-all shadow-sm ${compact ? "px-4 py-2" : "px-6 py-3"
                }`}
        >
