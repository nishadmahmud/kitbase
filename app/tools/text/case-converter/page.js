    ...
    return (
        <div className="min-h-screen bg-gray-950 pb-12">
            ...
            <div className="max-w-5xl mx-auto px-6 -mt-8 relative z-10 flex flex-col gap-6">
                ...
                {/* Control Bar */}
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-2 flex flex-wrap gap-2 justify-center shadow-lg">
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-2 flex flex-wrap gap-2 justify-center shadow-lg">
                    ...
                    <button
                        ...
                        className="px-4 py-2.5 rounded-xl text-sm font-medium bg-gray-800 text-gray-200 hover:bg-gray-700 hover:text-white transition-all flex-1 min-w-[120px] border border-gray-800"
                    >
                        Download .txt
                    </button>
                </div>
...
function ActionButton({ onClick, label }) {
    return (
        <button
            onClick={onClick}
            className="px-4 py-2.5 rounded-xl text-sm font-medium bg-gray-950 text-gray-400 border border-gray-800 hover:bg-gray-800 hover:text-gray-200 hover:border-gray-700 transition-all flex-1 min-w-[100px]"
        >
            {label}
        </button>
    );
