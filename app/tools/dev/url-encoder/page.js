        ...
        <div className="min-h-screen pb-12 transition-colors duration-300">
            ...
            <div className="max-w-5xl mx-auto px-6 -mt-8 relative z-10 flex flex-col gap-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {/* Input Area */}
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden flex flex-col h-[400px] shadow-sm dark:shadow-2xl dark:shadow-black/20 transition-colors">
                        <div className="px-5 py-3 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-950 flex justify-between items-center">
                            <span className="text-xs font-semibold text-gray-500 dark:text-gray-500 uppercase tracking-wider">Input</span>
                            <button
                ...
                {/* Controls */}
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 flex flex-col items-center gap-6 shadow-sm dark:shadow-none">
                    <div className="flex bg-gray-100 dark:bg-gray-950 rounded-xl p-1 border border-gray-200 dark:border-gray-800">
                        <button
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-8 py-3 rounded-xl text-base font-semibold bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 hover:scale-105 transition-all shadow-lg shadow-gray-900/10 dark:shadow-gray-100/10"
                    >
