                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden flex flex-col h-[500px] shadow-lg">
                        <div className="px-5 py-3 border-b border-gray-800 bg-gray-950 flex justify-between items-center">
                            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Input XML</span>
                            <button
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden flex flex-col h-[500px] shadow-lg">
                        <div className="px-5 py-3 border-b border-gray-800 bg-gray-950 flex justify-between items-center">
                            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Formatted XML</span>
                            <button
                                onClick={handleCopy}
                                disabled={!output}
